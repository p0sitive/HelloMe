package com.netease.nim.HelloMe.session;
...
import com.netease.nim.HelloMe.DemoCache;
import com.netease.nim.HelloMe.R;
import com.netease.nim.HelloMe.contact.activity.UserProfileActivity;
import com.netease.nim.HelloMe.session.action.AVChatAction;
import com.netease.nim.HelloMe.session.action.FileAction;
import com.netease.nim.HelloMe.session.action.GuessAction;
import com.netease.nim.HelloMe.session.action.RTSAction;
import com.netease.nim.HelloMe.session.action.SnapChatAction;
import com.netease.nim.HelloMe.session.action.TipAction;
import com.netease.nim.HelloMe.session.activity.MessageHistoryActivity;
import com.netease.nim.HelloMe.session.activity.MessageInfoActivity;
import com.netease.nim.HelloMe.session.extension.CustomAttachParser;
import com.netease.nim.HelloMe.session.extension.CustomAttachment;
import com.netease.nim.HelloMe.session.extension.GuessAttachment;
import com.netease.nim.HelloMe.session.extension.RTSAttachment;
import com.netease.nim.HelloMe.session.extension.SnapChatAttachment;
import com.netease.nim.HelloMe.session.extension.StickerAttachment;
import com.netease.nim.HelloMe.session.search.SearchMessageActivity;
import com.netease.nim.HelloMe.session.viewholder.MsgViewHolderAVChat;
import com.netease.nim.HelloMe.session.viewholder.MsgViewHolderDefCustom;
import com.netease.nim.HelloMe.session.viewholder.MsgViewHolderFile;
import com.netease.nim.HelloMe.session.viewholder.MsgViewHolderGuess;
import com.netease.nim.HelloMe.session.viewholder.MsgViewHolderRTS;
import com.netease.nim.HelloMe.session.viewholder.MsgViewHolderSnapChat;
import com.netease.nim.HelloMe.session.viewholder.MsgViewHolderSticker;
import com.netease.nim.HelloMe.session.viewholder.MsgViewHolderTip;
