package com.netease.nim.HelloMe.main.activity;
...
import com.netease.nim.HelloMe.avchat.AVChatProfile;
import com.netease.nim.HelloMe.avchat.activity.AVChatActivity;
import com.netease.nim.HelloMe.chatroom.helper.ChatRoomHelper;
import com.netease.nim.HelloMe.config.preference.UserPreferences;
import com.netease.nim.HelloMe.contact.activity.AddFriendActivity;
import com.netease.nim.HelloMe.login.LoginActivity;
import com.netease.nim.HelloMe.login.LogoutHelper;
import com.netease.nim.HelloMe.main.fragment.HomeFragment;
import com.netease.nim.HelloMe.session.SessionHelper;
import com.netease.nim.HelloMe.team.TeamCreateHelper;
import com.netease.nim.HelloMe.team.activity.AdvancedTeamSearchActivity;
...
public class MainActivity extends UI {
     ...
     * 2.设置界面{@link com.netease.nim.HelloMe.main.activity.SettingsActivity} 以及
     * 免打扰设置界面{@link com.netease.nim.HelloMe.main.activity.NoDisturbActivity} 也应添加 push 免打扰的逻辑
     * <p>
    ...
    private void onParseIntent() {
        ...
        } else if (intent.hasExtra(com.netease.nim.HelloMe.main.model.Extras.EXTRA_JUMP_P2P)) {
            Intent data = intent.getParcelableExtra(com.netease.nim.HelloMe.main.model.Extras.EXTRA_DATA);
            String account = data.getStringExtra(com.netease.nim.HelloMe.main.model.Extras.EXTRA_ACCOUNT);
